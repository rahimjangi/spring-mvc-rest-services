...
//@Component
public class NIORequestTemplateCustomizer implements RestTemplateCustomizer {
    ...
    public ClientHttpRequestFactory clientHttpRequestFactory()throws IOReactorException{
        ...
        final PoolingHttpClientConnectionManager connectionManager=
                new PoolingHttpClientConnectionManager((HttpConnectionFactory<HttpRoute, ManagedHttpClientConnection>) ioReactor);
